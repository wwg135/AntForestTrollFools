...
- 蚂蚁庄园：独立开关；自动每日签到、小课堂智能满分答题、智能防重喂养（优先逐个投喂高级饲料）、自动收取小鸡金色肥料、一键批量领取已完成的饲料奖励，以及赶走访客、小鸡睡觉、家庭签到、收鸡蛋与抽抽乐自动攒次数（满 10 次连抽、活动到期当天全抽）。
...
7. 点击右上角齿轮进入“功能设置”：可管理多个每日固定收取时刻（点选修改、左滑删除）、“步数模拟”、“好友浇水设置”、“神奇海洋（自动任务）”、“领奖励 & 森林寻宝”、“AI摸鱼”、“芭芭农场”、“蚂蚁庄园”、“隐藏理财”、“新版保护地（大富翁）”、“赚能量（打地鼠玩法）”和“自动复活好友过期能量”独立开关。好友浇水支持手动执行、定时执行，以及“打开蚂蚁森林自动浇水”独立开关。
