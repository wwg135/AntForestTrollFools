...
@property (assign, nonatomic) BOOL enableAutoManor;
@property (assign, nonatomic) BOOL enableAutoCook; // 芭芭农场做美食（小鸡厨房）：进农场页自动领食材→做满→清垃圾 // 蚂蚁庄园全自动日常（签到、小课堂答题、领饲料、喂小鸡（含高级饲料逐个投喂）、收肥料、赶走访客、小鸡睡觉、家庭签到、收鸡蛋）
